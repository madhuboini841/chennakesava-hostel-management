...
INSERT INTO settings (setting_key, setting_value) VALUES ('sms_target_student', 'true') ON CONFLICT (setting_key) DO NOTHING;
INSERT INTO settings (setting_key, setting_value) VALUES ('sms_target_parent', 'false') ON CONFLICT (setting_key) DO NOTHING;
INSERT INTO settings (setting_key, setting_value) VALUES ('sms_template_due_soon', 'Dear {name}, your hostel fee of Rs.{amount} is due in {days} days ({due_date}). Please pay on time to avoid late fees.') ON CONFLICT (setting_key) DO NOTHING;
INSERT INTO settings (setting_key, setting_value) VALUES ('sms_template_overdue', 'URGENT: Dear {name}, your hostel fee of Rs.{amount} is OVERDUE. Due date was {due_date}. Please pay immediately.') ON CONFLICT (setting_key) DO NOTHING;
